...
class Game:
    def __init__(self):
        ...
        pygame.display.set_caption("Chess with Wind Disasters")
    ...
    def draw_ui(self):
        ...
        # Keybind panel
        title_text = self.font.render("Keybinds", True, BLACK)
        self.screen.blit(title_text, (panel_x, panel_y + 125))
        ...
        for index, text_value in enumerate(keybinds):
            key_text = key_font.render(text_value, True, DARK_GRAY)
            self.screen.blit(key_text, (panel_x, panel_y + 160 + index * 22))

        if self.wind_timer > 0:
            effect_text = self.small_font.render("WIND BLOWING!", True, RED)
            self.screen.blit(effect_text, (panel_x, panel_y + 270))
            self.wind_timer -= 1
        ...
        while running:
            ...
            for event in pygame.event.get():
                if event.type == pygame.QUIT:
                    ...
                    button_rect = None  # We'll get this from draw_ui
